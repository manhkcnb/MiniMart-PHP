...
class HomeController extends Controller
{
    ...
    public static function getProductsInCategory($category_id){
        $products = DB::table("products")->where("category_id","=",$category_id)->orderBy("id","desc")->skip(0)->take(5)->get();
        return $products;
    } 
    public static function hotNews(){
        $news = DB::table("news")->where("hot","=",1)->orderBy("id","desc")->skip(0)->take(4)->get();
        return $news;
    } 
}
