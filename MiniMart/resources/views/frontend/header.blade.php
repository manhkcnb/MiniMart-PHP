...
<header id="header" >
<!-- top header -->
<div class="top-header" style="background-color: #fe8237;">
  <div class="container" >
    <div class="row">
...
<!-- end top header --> 
<!-- middle header -->
<div class="mid-header" style="background-color: #fe8237;">
<div class="container" style="background-color: #fe8237; width: 1560px; ">

  <div class="row" style="margin-left: 150px;" >
    <div class="col-xs-12 col-sm-12 col-md-3 logo " > <a href="{{ asset('') }}" style="width: 150px"> <img style="width: 150px" src="{{ asset('frontend/images/logo.png') }}" alt="DKT Store" title="DKT Store" class="img-responsive"> </a> </div>
...
<!-- end middle header --> 
<!-- bottom header -->
<div class="bottom-header" style="background-color: #fe8237;" >
  <div class="container">
    <div class="clearfix">
